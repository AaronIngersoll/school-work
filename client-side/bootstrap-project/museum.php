    ...
    <h1>Image Gallery</h1>
        <div class="row">
            <div class="col-md-4">
                ...
                <img class="thumbnail" src="computerphotos\1970sComputer.jpg" width="150" height="150" /></a>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <img class="thumbnail" src="computerphotos\1979Atari.jpg" width="150" height="150" /></a>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <img class="thumbnail" src="computerphotos\1991Linus.jpg" width="150" height="150" /></a>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <a href="computerphotos\AppleLisa.jpg">
                <img class="thumbnail" src="computerphotos\AppleLisa.jpg" width="150" height="150" /></a>
            </div>
        </div>
    </div>
</body>
